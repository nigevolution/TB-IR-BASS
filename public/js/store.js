...
const produtos = [
  ...
  { nome:"Lakland SS44-75 IR", preco:59, link:"https://pay.cakto.com.br/wgonjnx_723722", desc:"Boutique americano com punch absurdo.", audio:"/audio/lakland-sl-44-75.mp3", release:"2026-01-13T19:00:00", status:"LANÇAMENTO" },
  { nome:"Sadowsky NYC IR", preco:59, link:"https://pay.cakto.com.br/EXEMPLO", desc:"Flagship nova-iorquino.", audio:"/audio/sadowsky-nyc.mp3", release:"2026-01-20T12:00:00", status:"LANÇAMENTO" },
  { nome:"Mayones Jabba 5 IR", preco:null, link:null, desc:"Flagship europeu.", status:"LANÇAMENTO" },
  { nome:"MTD 535-24 IR", preco:null, link:null, desc:"Boutique luthier.", status:"LANÇAMENTO" },
...
produtos.forEach(p=>{
  ...
  if(p.audio){
    html += `
      <button class="preview-btn" onclick="playPreview('${p.audio}', this)">
        ▶ Preview 30s
      </button>
    `;
  }
